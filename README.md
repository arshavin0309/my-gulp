...
│   │   └── style.min.css.map       # Карта исходников, нужен для отладки минифицированного CSS
│   │
...
│   │   └── остальные js            # Можно создавать сколько угодно
│   │
...
│   │
│   ├── web.config                  # конфигурационный файл для веб-сервера IIS (выводит 404 страницу)
│   │
